...
from common import LAB_P_TTRAP, LAB_TTRAP, exp_trapping_events, fit_exponential_log_space, log_bins, save, set_style_framed
...
def draw_distribution(ax, times, bins, label, color, marker):
...
def main():
    ...
    for lo, hi, label, color, marker in LENGTH_CLASSES:
        ...
        draw_distribution(ax, times, bins, label, color, marker)
