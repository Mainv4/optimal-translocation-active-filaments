...
from common import (CMAP_ACTIVITY, CMAP_KAPPA, F_SIM_TO_NN, LAB_FA_NN, LAB_KAPPA, LAB_TAU_EC,
                    LAB_TTRAP, add_exp_markers, exp_table, paper_filter, save, set_style,
                    sim_table)
...
def draw(ax, sim, exp, color_by="Pe"):
...
def main(color_by="Pe", name="fig5_trapping_time_vs_decorrelation_time"):
    set_style()
    ...
    sc, label = draw(ax, sim, exp, color_by)
